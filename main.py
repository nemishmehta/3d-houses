...
if __name__ == '__main__':
    ...
    if len(address) > 0:
        ...
        if len(address_dict['LocationResult']) == 0:
            ...
            # plot_polygon is required only for method 2 of cropping area
            plot_surface, x_min_prop, y_min_prop, x_max_prop, y_max_prop, plot_polygon = get_plot_area_shape(
                x_coord, y_coord)
            ...
            dsm_arr = get_cropped_area('DSM', tif_file, x_min_prop, x_max_prop,
                                       y_min_prop, y_max_prop, plot_polygon)
